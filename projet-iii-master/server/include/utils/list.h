...
#define list_entry_is_head(pos, head, member) (((void*)pos + offsetof(typeof(*pos), member)) == (void*)(head))
...
#define list_for_each_entry(pos, head, member)				\
	for (pos = list_first_entry(head, typeof(*pos), member);	\
	     !list_entry_is_head(pos, head, member) && assert_align(pos); \
...
#define list_for_each_entry_safe(pos, n, head, member)			\
	for (pos = list_first_entry(head, typeof(*pos), member),  n = pos; \
	     !list_entry_is_head(pos, head, member) && (n = list_next_entry(n, member), assert_align(pos)); \
	     pos = n)
...
#define list_for_each_entry_safe_continue(pos, n, head, member)	\
	for (pos = list_next_entry(pos, member), n = pos; \
	     !list_entry_is_head(pos, head, member) && (n = list_next_entry(n, member), assert_align(pos), assert_align(n)); \
	     pos = n)
